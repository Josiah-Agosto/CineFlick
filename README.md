...
# Main Features
### Entirely Programmatically Made, No CocoaPods, Light / Dark Mode, Language Accessibility for Movies, Search Content, Loading Splash Screen, Image Caching, Custom Slide Menu, Movie Database API, Multi-Threading, Unit Testing.
